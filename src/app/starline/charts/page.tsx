...
// Helper to sort time strings (e.g., "10:00 AM") chronologically
...
export default function StarlineChartsPage() {
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
                    <TableHead className="font-bold text-blue-900">Time Slot</TableHead>
                    <TableHead className="text-center font-bold text-blue-900">Result (Panna - Digit)</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {games.length === 0 ? (
                      ...
                      return (
                        <TableRow key={game.id} className="border-b">
                          ...
                          <TableCell className="text-center">
                            <div className="inline-block bg-gray-800 text-white px-3 py-1 rounded-full font-mono text-sm tracking-widest">
