      ...
      <div className="max-w-md mx-auto">
        <Card>
          <CardHeader className="items-center text-center">
            {/* Avatar container - overflow-hidden taaki icon shape ke andar rahe */}
            <Avatar className="h-24 w-24 mb-4 border-2 border-primary/10 bg-transparent">
              <svg 
                viewBox="0 0 508 508" 
            ...
            <CardDescription className="text-lg">{currentUser.mobile}</CardDescription>
            
            <div className="pt-4">
              <Card className="bg-muted/40 inline-block">
                <CardContent className="p-2 px-4">
                  <div className="flex items-center gap-2">
                    <Wallet className="w-4 h-4 text-primary" />
                    <span className="text-sm font-medium">Balance:</span>
                    <span className="text-lg font-bold">₹{currentUser.balance?.toLocaleString() || '0'}</span>
                  </div>
                </CardContent>
              </Card>
            </div>
